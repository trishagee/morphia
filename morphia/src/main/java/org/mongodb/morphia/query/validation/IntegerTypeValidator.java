...
/**
 * If the Type is some sort of integer-compatible field (see {@code getTypeClasses}) then this validator will check if the value is of 
...
public final class IntegerTypeValidator extends TypeValidator {
    ...
    private List<Class<?>> getTypeClasses() {
        return Arrays.<Class<?>>asList(int.class, long.class, Long.class, Integer.class);
    }
