...
public class GeometryShapeConverterTest extends TestBase {
    ...
    public void shouldConvertAnEntityWithAPolygonGeoJsonType() {
        ...
        Geometry polygon = GeoJson.polygon(lineString(point(1.1, 2.0), point(2.3, 3.5), point(3.7, 1.0), point(1.1, 2.0)),
        ...
        // when
        Object encodedPolygon = converter.encode(Optional.of(polygon));
    ...
    public void shouldCorrectlyEncodePointsIntoEntityDocument() {
        ...
        // when
        Object dbObject = pointConverter.encode(Optional.of(point), null);
    ...
    public void shouldEncodeAnEntityWithAMultiLineStringGeoJsonType() {
        ...
        converter.setMapper(getMorphia().getMapper());
        Geometry multiLineString = GeoJson.multiLineString(lineString(point(1, 2), point(3, 5), point(19, 13)),
        ...
        // when
        Object encoded = converter.encode(Optional.of(multiLineString));
    ...
    public void shouldEncodeAnEntityWithAMultiPolygonGeoJsonType() {
        ...
        Polygon polygonWithHoles = GeoJson.polygon(lineString(point(1.1, 2.0), point(2.3, 3.5), point(3.7, 1.0), point(1.1, 2.0)),
                                                   ...
                                                   lineString(point(2.2, 2.1), point(2.4, 1.9), point(2.4, 1.7), point(2.1, 1.8),
                                                              point(2.2, 2.1)));
        Geometry multiPolygon = GeoJson.multiPolygon(GeoJson.polygon(point(1.1, 2.0),
                                                                         point(2.3, 3.5),
                                                                         point(3.7, 1.0),
                                                                         point(1.1, 2.0)),
                                                         polygonWithHoles);
        ...
        // when
        Object encoded = converter.encode(Optional.of(multiPolygon));
    ...
    public void shouldSaveAnEntityWithALineStringGeoJsonType() {
        ...
        converter.setMapper(getMorphia().getMapper());
        Geometry lineString = lineString(point(1, 2), point(3, 5), point(19, 13));

        // when
        Object encodedLineString = converter.encode(Optional.of(lineString));
